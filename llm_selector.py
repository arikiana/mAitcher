...
# Quellen:
    ...
    # Streamlit. (o.D.). st.session_state. Streamlit documentation. Abgerufen am 2. Mai, 2025, von https://docs.streamlit.io/develop/api-reference/caching-and-state/st.session_state
